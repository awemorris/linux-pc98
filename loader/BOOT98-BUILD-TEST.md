...
`loader/BOOT98.BIN`, the applet self-test, and both IPLware return-style
self-tests.

Create a basic FAT16 test disk:

```sh
BOOT98_STAGE2=loader/BOOT98.BIN \
  loader/make-boot98-test-image.sh build/boot98/boot98.img
```
